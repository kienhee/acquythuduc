...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="javascript:void(0);">Đối tác</a>
            </li>
    ...
    <div class="card mb-4">
        ...
        <form action="{{ route('dashboard.partners.update', 1) }}" method="post" class="card-body">
            @csrf
            @method('put')
            <div class="mb-3">
                <div class="upload__box">
                    ...
                    <input id="thumbnail" class="form-control" type="text" name="images"
                        value="{{ $partners->images ?? '' }}" hidden multiple>
                    <div id="holder" class="d-flex justify-content-center gap-3 flex-wrap">
                        @if ($partners && $partners->images)
                            @foreach (explode(',', $partners->images) as $item)
