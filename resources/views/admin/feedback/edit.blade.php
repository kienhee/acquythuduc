            ...
            <div class="card-body">
                ...
                <div class="row mt-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="feedback" class="form-control" name="feedback" rows="5" placeholder="Tối đa 255 ký tự">{{ old('feedback') ?? $feedback->feedback }}</textarea>
                        @error('feedback')
                            <p class="text-danger my-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="feedback_en" class="form-control" name="feedback_en" rows="5" placeholder="Tối đa 255 ký tự">{{ old('feedback_en') ?? $feedback->feedback_en }}</textarea>
                        @error('feedback_en')
                            <p class="text-danger my-1">{{ $message }}</p>
                        @enderror
                    </div>
